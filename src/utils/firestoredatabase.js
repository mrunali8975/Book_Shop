...
const dref = firestore().collection('Books');

const logoimage ='/home/mambhore/React Native/RNnotificationdemo/src/assets/download.png';


  // to add books details in cloud store
function Addbooks(title, author, price) {
  dref.add({
    Title: title,
    Author: author,
    Price: price,
      ...
      renderItem={item => {
        return (
          ...
          <Card containerStyle={{borderRadius:10,elevation:15}}>
            ...
            <View>
            <Card.Image  style={{width:100,height:100,marginRight:10}} source={require(logoimage)}/>
            </View>
...
export {Addbooks, Display, Delete};
